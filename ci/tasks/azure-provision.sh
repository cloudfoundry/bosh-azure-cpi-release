...
echo -e "export AZURE_STORAGE_ACCESS_KEY=$(azure storage account keys list ${AZURE_STORAGE_ACCOUNT_NAME} -g sedouard-cloudfoundry --json | jq '.storageAccountKeys.key1')" >> $export_file