...
describe Bosh::AzureCloud::DiskId do
  ...
  describe '#self.parse' do
    ...
    context 'when id contains ":"' do
      ...
      it 'should initialize a v2 disk_id' do
        expect do
          disk_id = Bosh::AzureCloud::InstanceIdParser.parse(id, default_resource_group_name)
          expect(disk_id.instance_variable_get('@plain_id')).to eq(nil)
  ...
  describe '#to_s' do
    context 'when disk id is a v1 id' do
      ...
      let(:disk_id) { Bosh::AzureCloud::InstanceIdParser.parse(disk_id_string, 'default-resource-group-name') }
    ...
    context 'when disk id is a v2 id' do
      context 'when disk id is initialized by self.parse' do
        ...
        let(:disk_id) { Bosh::AzureCloud::InstanceIdParser.parse(disk_id_string, 'r') }
      ...
      context 'when the same disk id is initialized by self.create and self.parse' do
        ...
        let(:disk_id_2) { Bosh::AzureCloud::InstanceIdParser.parse(disk_id_1.to_s, resource_group_name) }
  ...
  describe '#resource_group_name' do
    context 'when disk id is a v1 id' do
      ...
      let(:disk_id) { Bosh::AzureCloud::InstanceIdParser.parse(disk_id_string, default_resource_group_name) }
    ...
    context 'when disk id is a v2 id' do
      context 'when disk id contains resource_group_name' do
        ...
        let(:disk_id) { Bosh::AzureCloud::InstanceIdParser.parse(disk_id_string, 'fake-resource-group-name') }
