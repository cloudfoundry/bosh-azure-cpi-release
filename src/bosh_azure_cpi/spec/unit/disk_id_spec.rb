...
describe Bosh::AzureCloud::DiskId do
    ...
    context 'when id contains ":"' do
      ...
      it 'should initialize a v2 disk_id' do
        expect(Bosh::AzureCloud::DiskId).to receive(:new).
          ...
          and_return(disk_id)
        expect {
          Bosh::AzureCloud::DiskId.parse(id, azure_properties)
        }.not_to raise_error
      end
    end
  ...
  describe '#to_s' do
    context 'when disk id is a v1 id' do
      ...
      let(:disk_id) { Bosh::AzureCloud::DiskId.parse(disk_id_string, azure_properties) }
    ...
    context 'when disk id is a v2 id' do
      ...
      context 'when the same disk id is initialized by self.create and self.parse' do
        ...
        let(:disk_id_2) { Bosh::AzureCloud::DiskId.parse(disk_id_1.to_s, azure_properties) }
  ...
  describe '#caching' do
    ...
    context 'when disk name does not start with bosh-disk-data or bosh-data' do
      ...
      it 'should raise an error' do
        expect {
          disk_id.caching()
        }.to raise_error /This function should only be called for data disks/
      end
    end
  end
    ...
    context 'disk name' do
      context 'when it is empty' do
        ...
        it 'should raise an error' do
          expect {
            disk_id.validate()
          }.to raise_error /Invalid disk_name in disk id \(version 2\)/
        end
      end
    end
    ...
    context 'caching' do
      context 'when it is nil' do
        ...
        it 'should raise an error' do
          expect {
            disk_id.validate()
          }.to raise_error /Invalid caching in disk id \(version 2\)/
        end
      end
    ...
    context 'resource_group_name' do
     context 'when it is empty' do
        ...
        it 'should raise an error' do
          expect {
            disk_id.validate()
          }.to raise_error /Invalid resource_group_name in disk id \(version 2\)/
        end
      end
    end
    ...
    context 'storage_account_name' do
      context 'when it is nil' do
        ...
        it 'should raise an error' do
          expect {
            disk_id.validate()
          }.to raise_error /Invalid storage_account_name in disk id \(version 2\)/
        end
      end
