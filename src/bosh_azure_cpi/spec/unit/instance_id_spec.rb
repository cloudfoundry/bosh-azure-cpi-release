...
describe Bosh::AzureCloud::VMInstanceId do
  ...
  describe '#self.parse' do
    ...
    context 'when id contains ":"' do
      ...
      it 'should initialize a v2 instance_id' do
        expect do
          instance_id = Bosh::AzureCloud::CloudIdParser.parse(id, default_resource_group_name)
          expect(instance_id.instance_variable_get('@plain_id')).to eq(nil)
  ...
  describe '#to_s' do
    context 'when instance id is a v1 id' do
      ...
      let(:instance_id) { Bosh::AzureCloud::CloudIdParser.parse(instance_id_string, 'default-resource-group-name') }
    ...
    context 'when instance id is a v2 id' do
      context 'when instance id is initialized by self.parse' do
        ...
        let(:instance_id) { Bosh::AzureCloud::CloudIdParser.parse(instance_id_string, default_resource_group_name) }
      ...
      context 'when the same instance id is initialized by self.create and self.parse' do
        ...
        let(:instance_id_2) { Bosh::AzureCloud::CloudIdParser.parse(instance_id_1.to_s, resource_group_name) }
  ...
  describe '#vm_name' do
    context 'when instance id is a v1 id' do
      ...
      let(:instance_id) { Bosh::AzureCloud::CloudIdParser.parse(instance_id_string, 'fake-resource-group-name') }
    ...
    context 'when instance id is a v1 id' do
      context 'when it is a unmanaged disk vm and length of agent id is not 36' do
        ...
        it 'should raise an error' do
          expect do
            Bosh::AzureCloud::CloudIdParser.parse(instance_id_string, 'fake-resource-group-name')
