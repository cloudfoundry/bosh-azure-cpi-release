...
describe Bosh::AzureCloud::VMInstanceId do
  describe '#self.create' do
    ...
    context 'when storage_account_name is nil' do
      ...
      it 'should initialize the instance_id' do
        instance_id = Bosh::AzureCloud::VMInstanceId.create(resource_group_name, agent_id)
    ...
    context 'when storage_account_name is NOT nil' do
      ...
      it 'should initialize the instance_id' do
        instance_id = Bosh::AzureCloud::VMInstanceId.create(resource_group_name, agent_id, storage_account_name)
        expect(instance_id.instance_variable_get('@plain_id')).to eq(nil)
        expect(instance_id.instance_variable_get('@id_hash')).to eq(id)
      end
    end
  ...
  describe '#self.parse' do
    ...
    context 'when id contains ":"' do
      ...
      it 'should initialize a v2 instance_id' do
        expect do
          instance_id = Bosh::AzureCloud::InstanceIdParser.parse(id, default_resource_group_name)
          expect(instance_id.instance_variable_get('@plain_id')).to eq(nil)
  ...
  describe '#to_s' do
    context 'when instance id is a v1 id' do
      ...
      let(:instance_id) { Bosh::AzureCloud::InstanceIdParser.parse(instance_id_string, 'default-resource-group-name') }
    ...
    context 'when instance id is a v2 id' do
      context 'when instance id is initialized by self.parse' do
        ...
        let(:instance_id) { Bosh::AzureCloud::InstanceIdParser.parse(instance_id_string, default_resource_group_name) }
      ...
      context 'when instance id is initialized by self.create' do
        ...
        let(:instance_id) { Bosh::AzureCloud::VMInstanceId.create(resource_group_name, agent_id, storage_account_name) }
      ...
      context 'when the same instance id is initialized by self.create and self.parse' do
        ...
        let(:storage_account_name) { 'fakestorageaccountname' }
        let(:instance_id_string) { "agent_id:#{agent_id};resource_group_name:#{resource_group_name};storage_account_name:#{storage_account_name}" }
        let(:instance_id_1) { Bosh::AzureCloud::VMInstanceId.create(resource_group_name, agent_id, storage_account_name) }
        let(:instance_id_2) { Bosh::AzureCloud::InstanceIdParser.parse(instance_id_1.to_s, resource_group_name) }
  ...
  describe '#vm_name' do
    context 'when instance id is a v1 id' do
      ...
      let(:instance_id) { Bosh::AzureCloud::InstanceIdParser.parse(instance_id_string, 'fake-resource-group-name') }
    ...
    context 'when instance id is a v1 id' do
      context 'when it is a unmanaged disk vm and length of agent id is not 36' do
        ...
        it 'should raise an error' do
          expect do
            Bosh::AzureCloud::InstanceIdParser.parse(instance_id_string, 'fake-resource-group-name')
    ...
    context 'when instance id is a v2 id' do
      context 'when validating resource_group_name' do
        context 'when it is nil' do
          let(:instance_id) { Bosh::AzureCloud::VMInstanceId.create(nil, 'agent-id', 'storage-account-name') }
        ...
        context 'when it is empty' do
          let(:instance_id) { Bosh::AzureCloud::VMInstanceId.create('', 'agent-id', 'storage-account-name') }
      ...
      context 'when validating vm_name' do
        context 'when it is nil' do
          let(:instance_id) { Bosh::AzureCloud::VMInstanceId.create('resource-group-name', nil, 'storage-account-name') }
        ...
        context 'when it is empty' do
          let(:instance_id) { Bosh::AzureCloud::VMInstanceId.create('resource-group-name', '', 'storage-account-name') }
      ...
      context 'when validating storage_account_name' do
        context 'when it is empty' do
          let(:instance_id) { Bosh::AzureCloud::VMInstanceId.create('resource-group-name', 'agent-id', '') }
