...
describe Bosh::AzureCloud::VMManagerAdaptive do
  ...
  context 'when vmss enabled' do
    ...
    it 'should not raise error' do
      ...
      expect do
        vm_manager_adaptive.create(bosh_vm_meta, location, vm_props, network_configurator, env_with_group)
  ...
  context 'when vmss disabled' do
    ...
    it 'should not raise error' do
      ...
      vm_manager_adaptive_vmss_disabled.create(bosh_vm_meta, location, vm_props, network_configurator, env_with_group)
    end
  end
end
