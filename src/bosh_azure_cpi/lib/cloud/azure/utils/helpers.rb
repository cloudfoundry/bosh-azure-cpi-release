...
module Bosh::AzureCloud
  module Helpers
    ...
    API_VERSIONS = {
      ...
      AZURE_RESOURCE_PROVIDER_COMPUTE_SNAPSHOT => '2023-04-02',
      AZURE_RESOURCE_PROVIDER_COMPUTE_GALLERY => '2023-07-03',
      AZURE_RESOURCE_PROVIDER_NETWORK => '2024-05-01',
      AZURE_RESOURCE_PROVIDER_STORAGE => '2026-04-01',
    ...
    STORAGE_ACCOUNT_TYPE_PREMIUMV2_LRS   = 'PremiumV2_LRS'
    STORAGE_ACCOUNT_TYPE_ULTRASSD_LRS    = 'UltraSSD_LRS'
    # Azure does not support in-place disk type conversion from these types; snapshot-based recreation is required.
    SNAPSHOT_CONVERSION_REQUIRED_TYPES   = [STORAGE_ACCOUNT_TYPE_PREMIUMV2_LRS, STORAGE_ACCOUNT_TYPE_ULTRASSD_LRS].freeze
    # These types only support disks with a 512 logical sector size, so a 4096-sector snapshot cannot be converted to them.
    SECTOR_SIZE_512_ONLY_TYPES           = [STORAGE_ACCOUNT_TYPE_STANDARD_LRS, STORAGE_ACCOUNT_TYPE_STANDARDSSD_LRS, STORAGE_ACCOUNT_TYPE_PREMIUM_LRS].freeze
