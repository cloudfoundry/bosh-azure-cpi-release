    ...
    def _get_or_create_availability_set(resource_group_name, availability_set_name, vm_props)
      ...
      flock("#{CPI_LOCK_PREFIX_AVAILABILITY_SET}-#{availability_set_name}", File::LOCK_EX) do
        ...
        if availability_set.nil?
          CPILogger.instance.logger.info("availability set '#{availability_set_name}' doesn't exist. Will create a new one.")
        ...
        # In some regions, the location of availability set is case-sensitive, e.g. CanadaCentral instead of canadacentral.
          ...
          CPILogger.instance.logger.info("availability set '#{availability_set_name}' exists, but it needs to be updated from unmanaged to managed.")
          ...
          CPILogger.instance.logger.info("availability set '#{availability_set_name}' exists. No need to update.")
        end
      end
