...
module Bosh::AzureCloud
  class VMManager
    ...
    def _get_availability_set_name(vm_props, env)
      ...
      if availability_set_name.nil? && !(env.nil? || env['bosh'].nil? || env['bosh']['group'].nil?)
        ...
        availability_set_name = "az-#{Digest::MD5.hexdigest(availability_set_name)}-#{availability_set_name[-40..]}" if availability_set_name.length > 80
      end
