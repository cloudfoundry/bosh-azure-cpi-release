...
module Bosh::AzureCloud
  class StemcellManager2 < StemcellManager
    ...
    def _get_storage_account(stemcell_name, location)
      ...
      storage_account = @storage_account_manager.get_or_create_storage_account_by_tags(STEMCELL_STORAGE_ACCOUNT_TAGS, STORAGE_ACCOUNT_TYPE_STANDARD_LRS, STORAGE_ACCOUNT_KIND_GENERAL_PURPOSE_V2, location, [STEMCELL_CONTAINER], false)
      storage_account_name = storage_account[:name]
